...
namespace TaskFlow.Persistence.Migrations
{
    ...
    [Migration("20260329235330_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Persistence.IdentityModels.AppRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TaskFlow.Persistence.IdentityModels.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TaskFlow.Persistence.IdentityModels.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaskFlow.Persistence.IdentityModels.AppUser", null)
                        .WithMany()
